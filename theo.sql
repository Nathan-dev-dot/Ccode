...
CREATE TABLE places(id integer auto_increment , name varchar(32) , address varchar(32) , map char(32) default null , primary key(id));
CREATE TABLE drink(id integer auto_increment , name varchar(32) , category varchar(32) , primary key(id));
CREATE TABLE _place_propose_drink(place integer , drink integer references drink(id), price integer , primary key(place,drink));
CREATE TABLE room(id integer auto_increment , name varchar(32) , max_capacity integer , price_half_day integer , place integer , primary key(id));
